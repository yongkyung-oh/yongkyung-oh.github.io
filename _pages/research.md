...
<div class="notice--info"> 
  <ul>
  <li>[C16] Oh, Y., & Bui, A. (2025). Multi-View Contrastive Learning for Robust Domain Adaptation in Medical Time Series Analysis, The AHLI Conference on Health, Inference, and Learning (CHIL) 2025, Association for Health Learning and Inference (AHLI), June 2025. <a href="">[paper]</a> <a href="">[code]</a> <a href="">[poster]</a></li>
